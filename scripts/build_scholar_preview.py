...
<footer class="preview-foot">
  ...
  <p>The release contains __PUBLIC_DOMAIN_TEXTS__ public-domain text rows,
     __OWN_WORK_TEXTS__ project-authored rows, __OPEN_LICENSE_TEXTS__ rows under
     their source licences, and __MEDIA_ROWS__ images with item-level rights
     statements. Bowlam's own contribution is CC BY 4.0; narrower source terms
     still govern their rows.</p>
  <p><a href="release-candidate.json">Release inventory and passed privacy checks</a>
     &middot; built __GENERATED__ &middot; pending project-owner approval.</p>
</footer>
<script>
