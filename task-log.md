...
- Migration is complete, but OPS-001 and OPS-002 remain unaccepted. The checksum-verified Restic 0.19.1 arm64 client is installed; Tailscale, the separate standard account, the external encrypted SSD, local and B2 Restic repositories, Healthchecks, schedules and both independent restore tests are not configured. The Mac mini readiness audit correctly remains failing, and all seventeen legacy SQLite snapshots were retained.
