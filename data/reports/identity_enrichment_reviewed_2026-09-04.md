...
- Working physical identity hypotheses (all statuses): **1316**
- Multi-record identity clusters: **173**
- Source records linked into those clusters: **1584**
...
**194** identities triggered raw difference flags. Current reviews support **10** compatible field-level instances and **5** substantive instances. **313** instances require review or revalidation; these are not established contradictions. No source claim or historical decision was deleted.
