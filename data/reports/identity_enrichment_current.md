...
- Working physical identity hypotheses (all statuses): **1317**
- Multi-record identity clusters: **173**
- Underlying source records (all identities): **1585**
...
**201** identities triggered raw difference flags. Current reviews support **18** compatible field-level instances and **6** substantive instances. **313** instances require review or revalidation; these are not established contradictions. No source claim or historical decision was deleted.
