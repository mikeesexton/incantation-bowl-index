...
class ScholarPreviewBuildTests(unittest.TestCase):
    ...
    def test_built_output_carries_a_reviewed_release_candidate(self):
        ...
        self.assertEqual(candidate['withheld_counts']['source_wording'], 34)
        self.assertEqual(candidate['withheld_counts']['text_content'], 24)
        self.assertEqual(candidate['withheld_counts']['media'], 34)
        self.assertEqual(candidate['withheld_counts']['private_capture_rows'], 58)
