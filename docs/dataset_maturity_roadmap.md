...
Generated: `2026-09-19T00:53:13+00:00`
...
1. RIGHTS-002 / ACCESS-003: continue evidence collection in shared institutional-policy batches now that all 327 media have current ledger holds. The first Ford/Levene pilot narrowed contact paths but made no rights decision; retain fail-closed treatment for protected texts, capture storage and every unapproved image.
...
- [ ] **RIGHTS-002 — Review all existing media records** · In progress · Human review
  ...
  - Evidence/status: 327/327 media now have current ledger rows; 0/327 have completed rights assessments and 0 are approved for public reuse. The first policy-evidence pilot visually checked the Ford 2023 Davidovitz 41 figure and Levene 1999 M163 plates, recorded the volume/journal notices and current official institutional metadata or terms, and narrowed the permission-contact path without inferring ownership or approval. Existing non-unknown copyright labels do not count as decisions.
