...
Saturation is bounded by the twelve source classes that were searched. Waller's 115-title list of JBA bowl publications (1853–2024) is used as a bibliography audit: every title now has a source record, so the project knows what it still needs to inspect. Bowl-level work is measured separately. The database currently resolves **33 publication editions covering 895 candidate records**, and its complete inspected edition units supply 565 page-located source appearances. See the [control-list measurement](data/reports/waller_control_list_2026-09-05.md), the [current mission plan](docs/dataset_maturity_roadmap.md), and the [scoping review alignment](data/reports/scoping_review_alignment_2026-09-05.md).

## Identity and enrichment status

The current corpus contains **1,969 records representing 1,652 working identity hypotheses**, with 2,268 appearances from 862 sources. These are working research classifications, not an overall accuracy estimate. Complete inspected editions and catalogues now include both *Aramaic Bowl Spells* volumes, Montgomery, Moriggi's Syriac corpus, Ford–Morgenstern's Hilprecht catalogue, Levene's curse-text volume, the modern Berlin catalogue, Burberry's 2020 thesis, Naveh–Shaked 1985, Pognon 1898–1899, Ellis's 1853 section, Stübe 1895, Wohlstein's 1893–1894 articles, and four Gordon articles from 1934–1937. Burberry adds 25 exact Berlin inventory overlaps without creating or merging identities. The Gordon batch adds 24 located appearances: 16 full bowl editions, of which 15 attach to existing exact-label or exact-number records and one is a new Harvard candidate, plus eight separately numbered museum bowls retained as new candidates. No uncertain identity was merged.

The public reading-room count is deliberately narrower than edition coverage. Its current release projection contains **252 readable rows**: 40 translations, 211 project or research summaries, and one transliteration. Another 21 rows retain their citation and locator while withholding protected or not-yet-approved scholarly wording. This does not mean that only those bowls are known from editions: 209 objects have a stored text record, 55 have a translation record, and many more have edition-level references without a locally stored transcription or translation. Mike's localhost-only reader exposes all 273 stored rows, including the private Davidovitz 41 translation and Aramaic transcription; that availability is not permission to redistribute them. The fifth Wohlstein reading still awaits a second review of embedded Hebrew strings, and stale content fingerprints fail closed instead of silently publishing changed text.
